                ...
                <TableRow key={index}>
                  <TableCell>
                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                      {login.username}
                      {(login.role as any) === 'root' && ' 👑'}
                      {(login.role as any) === 'professor' && ' 👨‍🏫'}
                    </Box>
                  </TableCell>
                  <TableCell>
                    <Chip 
                      label={(login.role as any) === 'student' ? 'طالب' : 
                             (login.role as any) === 'professor' ? 'أستاذ' : 'مدير'}
                      size="small"
                      color={(login.role as any) === 'root' ? 'warning' : 'primary'}
                    />
                  </TableCell>
